...
def main():
    ...
    "\nCache Lab summary:"
    print
    "%-22s%8s%10s%12s" % ("", "Points", "Max pts", "Misses")
    print
    "%-22s%8.1f%10d" % ("Csim correctness", csim_cscore[0],
                        maxscore['csim'])
    ...
    if miss32 == 2 ** 31 - 1:
        misses = "invalid"
    print
    "%-22s%8.1f%10d%12s" % ("Trans perf 32x32", trans32_score,
    ...
    if miss64 == 2 ** 31 - 1:
        misses = "invalid"
    print
    "%-22s%8.1f%10d%12s" % ("Trans perf 64x64", trans64_score,
    ...
    if miss61 == 2 ** 31 - 1:
        misses = "invalid"
    print
    "%-22s%8.1f%10d%12s" % ("Trans perf 61x67", trans61_score,
